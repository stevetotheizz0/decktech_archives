...
HBO:Control the Hoth sites to activate imperial decree. And a suprise attack

Any ground deck:Watch the size of you opponent’s hand and force pile have on big attack group followed by a slightly smaller group to wipe out everyone (if the opponent’s characters are in big groups). for smaller amounts of characters, thak an army of 2 or 3 characters in if thereare still chacters after the first battle there move in people from ajacent sites.
