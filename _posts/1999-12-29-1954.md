...
side: Dark
date: 1999-12-29
description: Forget Ops Manipulator(old news).Ring in
the new year w/some ECC style.
rating: 4.0
---
Cards: 

Objective:This Deal is Getting
...
Sabacc is Not the decks' theme:By the time your gonna want to play Sabacc every turn your opponent should have already used all his grabbers.
...
Dark Path:Loose 2 cards to ensure a good battle destiny.It's actually pretty good in this deck seeing as there are only 10 Characters. You'll want to have the upper hand in every battle.

Always start Any Methods/Boba w/gun/BFinS1/
CC:Security Tower

Play Dark Deal and CC:Occ. Only when you have total board and hand control.
