...
<option value="/premium/main/decktech.php?setheme=fellowship">Fellowship</option>
<option value="/premium/main/decktech.php?setheme=moria">Balrog&Gandalf</option>
-->
</select>
</div>
</form>
...
<td background="/lotr/gfx/mom/bro_05.gif" class="headerbg"><font class="h1font"><font color="#FFFFFF">Why players agree DeckTech is #1</font></B></td><td background="/lotr/gfx/mom/bro_06.gif"></td></tr>
	<tr><td background="/lotr/gfx/mom/whi_07.gif"></td>
		<td bgcolor="#FFFFFF" background="/lotr/gfx/mom/whi_08.gif"><font class="bfont"><p> Log in to DeckTech for the first time and you can't help but notice features and technology that sets DeckTech head-and-shoulders above any other gaming web site on the Internet.
<p>
...
Say what is on your mind! This message board system gives you the perfect place to shout out your opinion. Stay up to date on the latest rumors and news about Lord of the Rings TCG.
...
Sure the site has more features than any other gaming web site but DeckTech is more than a great web site about the Lord of the Rings Card Game. 
<p>
...
<p>
Our just released Lord of the Rings TCG site has brand-new features that have never before been available on any card gaming web site. Features like: 
<ul>
...
We match the cards in your deck list with the correct image of the card so people can see and understand how your deck works.
              ...
              <li><b>M.E. Outfitters</b><br>
                ...
                win random prizes. Through Middle-Earth Outfitters DeckTech rewards 
...
But we are not stopping there! Look for more exciting features, contest, and International Versions of our popular sites coming soon! 
            <p> With all of this, it's not hard to see why DeckTech is the #1 fan-based site 
              for the Lord of the Rings TCG. If you have not already signed up 
              for your <a href="join.php">free membership</a>, take a few minutes 
              to complete the process. By joining the leading online community 
              for Lord of the Ring TCG you can take part in shaping the future 
              of the game. 
            <p>
