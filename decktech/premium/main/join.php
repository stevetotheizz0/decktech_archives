...
<option value="/premium/main/join.php?setheme=fellowship">Fellowship</option>
<option value="/premium/main/join.php?setheme=moria">Balrog&Gandalf</option>
-->
</select>
</div>
</form>
...
<td background="/lotr/gfx/mom/red_05.gif" class="headerbg"><font class="h1font"><font color="#FFFFFF">Sign Me Up!</font></B></td><td background="/lotr/gfx/mom/red_06.gif"></td></tr>
	<tr><td background="/lotr/gfx/mom/whi_07.gif"></td>
		<td bgcolor="#FFFFFF" background="/lotr/gfx/mom/whi_08.gif"><font class="bfont"><form method="post" action="/premium/main/join.php" name="">
...
<tr>
	  ...
	  <input type='hidden' name='secretcode' value='6401' size=6>
		</td></tr>
<tr>
      <td width="103">&nbsp;</td>
      <td width="365">&nbsp;</td>
