...
<option value="/lotr/articles/features/rightime.php?setheme=fellowship">Fellowship</option>
<option value="/lotr/articles/features/rightime.php?setheme=moria">Balrog&Gandalf</option>
</select>
</div>
</form>
 </td>
...
<td background="/lotr/gfx/mom/red_05.gif" class="headerbg"><font class="h1font"><font color="#FFFFFF">The Right Card at the Right Moment</font></B></td><td background="/lotr/gfx/mom/red_06.gif"></td></tr>
	<tr><td background="/lotr/gfx/mom/whi_07.gif"></td>
		<td bgcolor="#FFFFFF" background="/lotr/gfx/mom/whi_08.gif"><font class="bfont"> 
            <p>By: <a href="http://www.decktech.net/lotr/main/mpage.php?member=8428">Marc 
              'Witch-King' THERY</a> (also <a href="rightime_french.php">available 
              in French</a>)</p>
            <p>&nbsp;</p>
            <table width="200" border="0" cellspacing="0" cellpadding="5" align="right">
              <tr valign="top"> 
                <td>Also by this author: <br>
                  <a href="dd.php">Direct Damage in the Lord Of The Rings TCG 
                  </a></td>
              </tr>
              <tr> 
                <td><img src="../../gfx/features/elrond.gif" width="200" height="240" align="right"></td>
              </tr>
            </table>
            <p>In LOTR TCG, and contrary to other card games, such as SWCCG, there 
            ...
            <p> We can divide the means in three categories : draw, retrieve and 
            ...
            <p> We'll review those three categories, both for the Free People 
            ...
            <p> When it's question of retrieving cards in hope of playing them 
            ...
            <p> Finally, there are the search cards, that allow you to search 
            ...
            <p> To conclude, I'd say that, there are actually more drawing mechanisms 
              ...
              more effective ways. 
            <p> Marc 'Witch-King' THERY.<br>
              " You're brave, little man.<br>
              But your courage alone will not save you ! "<br>
              Special thanks to Cédric 'Smoothkiller' CAUCAT.<br>
              <br>
