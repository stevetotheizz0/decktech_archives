...
<option value="/lotr/resources/download.php?setheme=fellowship">Fellowship</option>
<option value="/lotr/resources/download.php?setheme=moria">Balrog&Gandalf</option>
</select>
</div>
</form>
 </td>
...
<tr><td width=1 background="/lotr/gfx/mom/hdr_tll.gif"><img src="/lotr/gfx/mom/clear.gif" width=1 height=30></td>
     ...
     <tr>
      ...
      <td bgcolor="#421D21" class="r2body" width=88%><font class="bfont">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
