      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" vspace="0" hspace="0">
        ...
        <tr valign="top"> 
          ...
          <td width="98%" align="left"><img src="/stccg/global/images/trek/glear.gif" width="1" height="1" border="0" vspace="0" hspace="0"><!-- #BeginEditable "Body" --> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td bgcolor="#0099FF" colspan="2" valign="top" height="24"><img src="/stccg/global/images/trek/tablet1.gif" width="92" height="32"></td>
                <td valign="top" height="24" colspan="3"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td bgcolor="#0099FF" width="20%" height="13"><img src="/stccg/global/images/trek/glear.gif" width="1" height="19"></td>
                      <td width="0%" height="13"><img src="/stccg/global/images/trek/glear.gif" width="2" height="1"></td>
                      <td width="70%" bgcolor="#8543B1" height="13"></td>
                      <td width="7%" height="13"><img src="/stccg/global/images/trek/tab_decktech.gif" width="119" height="16" vspace="0" hspace="4"></td>
                      <td width="3%" bgcolor="#8543B1" align="right" height="13"><img src="/stccg/global/images/trek/tablet_cap.gif" width="18" height="19"></td>
                    </tr>
                    <tr> 
                      <td width="20%"><img src="/stccg/global/images/trek/glear.gif" width="1" height="12"></td>
                      <td width="0%"></td>
                      <td width="70%"></td>
                      <td width="7%"></td>
                      <td width="3%"></td>
              ...
              <tr> 
                <td width="80" bgcolor="#0099FF" height="40%"><img src="/stccg/global/images/trek/glear.gif" width="80" height="8" border="0" vspace="0" hspace="0"></td>
                ...
                <td rowspan="5" colspan="3" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td bgcolor="#000000" height="8" width="100%" colspan="3"><img src="/stccg/global/images/trek/glear.gif" width="1" height="5"><span class="header"><font face="Arial, Helvetica, sans-serif" size="2"><font face="Haettenschweiler, Impact, Arial Black" size="5" color="#FFFFFF"><font size="6" color="#FF9900">Frequently 
                        Asked Questions</font></font><font face="Haettenschweiler, Impact, Arial Black" size="5"><span class="header"></span></font></font> 
                        </span></td>
                    </tr>
                    <tr> 
                      ...
                      <td height="2" width="58%" bgcolor="#0099FF"><img src="/stccg/global/images/trek/glear.gif" width="1" height="5"></td>
                    </tr>
                  </table>
                  <p class="W_header"><font face="Arial, Helvetica, sans-serif" size="2"><font face="Haettenschweiler, Impact, Arial Black" size="5"><span class="header"> 
                    </span></font></font><font face="Haettenschweiler" size=5><span class="header"><img src="/stccg/global/images/trek/stock/impulseengine.jpg" width="377" height="190" align="right">Help, 
                    I Lost my Password!</span> <br>
                    </font><font face="Arial, Helvetica, sans-serif" size="2" class="text">Your 
                    password is available to you by email automatically. If for 
                    any reason you enter your password incorrectly you will see 
                    a large green link that says. "<a href="../../global/forgot.php">Forget 
                    Your Password?</a>" By clicking on this link you will be asked 
                    for your member name only. The DeckTech system will mail your 
                    password to the email address it currently has listed for 
                    you. For this reason it is important to keep your member information 
                    as up to date as possible. </font></p>
                  <p><font face="Arial, Helvetica, sans-serif" size="2"> <font face="Haettenschweiler, Impact, Arial Black" size="5"><span class="header">Can 
                    I use DeckTech decks and articles on my SW:CCG web site or 
                    in my magazine?</span></font></font><font face="Arial, Helvetica, sans-serif" size="2"><b><br>
                    <span class="text">For Web sites</span></b><span class="text">:<br>
                    If you have a membership you can ask the author directly through 
                    the member mail center for permission to post their article 
                    or deck. You can not post decks or article on your site without 
                    permission of the original author.<br>
                    <b>For Magazines or newsletters: </b><br>
                    You must obtain written permission from DeckTech or the originating 
                    authors to publish any of this sites content including decks, 
                    articles and tournament reports. DeckTech can be contacted 
                    at, <a href="mailto:info@decktech.net">info@decktech.net</a>.</span></font></p>
                  <p><font face="Haettenschweiler, Impact, Arial Black" size="5"><span class="header">Can 
                    I post a local tournament on your web site? </span></font><font face="Arial, Helvetica, sans-serif" size="2"><br>
                    <span class="text">You can post information about your local 
                    tournaments on your member page. Member pages are available 
                    to everyone who joins DeckTech. If you are promoting a large 
                    event contact the DeckTech event department at <a href="mailto:events@decktech.net">events@decktech.net</a> 
                    for more promotion options.</span></font></p>
                  <p><font face="Haettenschweiler, Impact, Arial Black" size="5"><span class="header">Can 
                    I get my Web Site listed in your links page?</span><br>
                    </font><font face="Arial, Helvetica, sans-serif" size="2" class="text">If 
                    the site is ST: CCG related you can add it yourself <a href="/stccg/resources/sitesubmit.php3">here</a>. 
                    All non-ccg related sites will be removed. All online SW:CCG 
                    retailers will be removed. For information on how to advertise 
                    your store contact <a href="mailto:info@decktech.net">info@decktech.net</a></font></p>
                  <p><font face="Haettenschweiler, Impact, Arial Black" size="5"><span class="header">Can 
                    I advertise my store on your web site?</span><br>
                    </font><font face="Arial, Helvetica, sans-serif" size="2" class="text">For 
                    information regaurding advertisement contact: <a href="mailto:info@decktech.net">info@decktech.net</a></font></p>
                  </td>
              </tr>
              <tr> 
              ...
              <tr> 
                <td width="80" bgcolor="#0099FF" height="489" valign="top" align="right">&nbsp;</td>
                <td width="12" height="489"><img src="/stccg/global/images/trek/glear.gif" width="1" height="4"></td>
              </tr>
              <tr> 
                ...
                <td height="22" colspan="3"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      ...
                      <td height="2" width="58%" bgcolor="#8543B1"></td>
                    </tr>
                  </table>
                </td>
              </tr>
          ...
          <td valign="top" align="left" width="190"> 
            <table width="155" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td width="130"><!-- #BeginEditable "SubNavigation" --><!-- #BeginLibraryItem "/Library/st_main.lbi" -->
<table border="0" cellspacing="0" cellpadding="0" vspace="0" hspace="0">
  <tr> 
    <td>&nbsp;<font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#000000" class="level2nav"><a href="/stccg/main/stccg.php3" class="level2nav">About 
      ST: CCG</a><a href="/www/articles/strategy.php3" class="level2nav"> </a></font></td></tr>
  <tr> 
