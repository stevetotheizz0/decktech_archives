          ...
          <td width="98%" align="left"><img src="/stccg/global/images/trek/glear.gif" width="1" height="1" border="0" vspace="0" hspace="0"><!-- #BeginEditable "Body" -->
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <td valign="top" height="24" colspan="3"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td width="9%" height="13"><img src="/stccg/global/images/trek/tab_communitybuzz.gif" width="135" height="18" vspace="0" hspace="4"></td>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr valign="top"> 
                      <td bgcolor="#000000" height="8" width="100%" colspan="3"><span class="W_header"><img src="/stccg/global/images/trek/glear.gif" width="1" height="5"></span> 
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td bgcolor="#000000" height="8" width="100%" colspan="3"><span class="W_header"><img src="/stccg/global/images/trek/glear.gif" width="1" height="5"><span class="W_header"><font face="Haettenschweiler, arial" size="5" color="#FFFFFF"><font size="6"><span class="W_header">C<span class="W_header">ommunity 
                              Buzz</span></span></font></font><font face="Haettenschweiler, Impact, Arial Black" size="5" color="#FFFFFF"></font></span></span></td>
                          </tr>
                          <tr> 
                        ...
                        <table width="100%" border="0" cellpadding="10">
                          <tr> 
                            <td width=55%> 
                              <p align="justify"><font size=-2 face="arial" color="white" class="text">NOTE: 
                                DeckTech accepts <u>NO</u> responsibility for 
                                rumors posted here. They are SOLELY the responsibility 
                                of the person making the claim. Completely Rude, 
                                Irresponsible, Derogatory, or Vulgar statements 
                                MAY be removed, if we feel like it. Believe what 
                                you choose to believe and EXPECT THE UNEXPECTED! 
                                </font></p>
                            </td>
                            <td align="center"> <font face="Haettenschweiler, Tahoma, Arial, sans-serif" size="5"> 
                              <a href="rumors.php3"><font size="6">Enter Community 
                              Buzz</font></a></font> </td>
                          </tr>
                          <tr valign="top"> 
                            <td width=55% colspan=2> 
                              <p align="justify"> <font face="arial" color="white" size="5"><span class="header"><img src="/stccg/global/images/trek/stock/Anim_redalert2.gif" width="160" height="118" align="right">Find 
                                out what people are talking about!</span></font><font face="Arial, Helvetica, sans-serif" color="#FFFFFF" size="2"><br>
                                <br>
                                <span class="text">This is where everything goes 
                                into warp speed! People can post any rumors related 
                                to swccg they have heard or sometimes even dreamed 
                                up here. Trust me, if you believe everything on 
                                this page, then you are truly a fool. However, 
                                mixed in with all that will be some truly interesting 
                                information. How can you tell... you must search 
                                your feelings. Some may make you happy, some may 
                                make you angry, and some you couldn't care less 
                                about. However, we expect most people will have 
                                a strong feeling one way or another. </span></font></p>
                              <p align="justify"><span class="text"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF" size="2"><span class="text">You 
                                may post a new topic or read / reply to topics 
                                by clicking on the appropriate links. Frequently, 
                                we here at DeckTech will post an opened ended 
                                rumor to get everyone going. The topics often 
                                range from posts about future cards and upcoming 
                                expansion, wish lists, politics, religion, abortion, 
                                some are posts just outright slamming someone. 
                                In other words, you can go from the heights of 
                                intellectualisms, to the depths of the gutter, 
                                in one click! </span><br>
                                <br>
                                <span class="text">Totally stupid posts like "Starfleet 
                                Academy is gay" will be removed. You may think 
                                this is censorship, well it is. We are censoring 
                                stupidity from the world but not controversy, 
                                so don't be afraid to say what's on your mind.</span></font></span></p>
                              <p align="justify"><span class="text"><span class="text"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF" size="2" class="text">Enjoy 
                                and use powers of observation, deduction and wit, 
                                and you will find this a truly rewarding experience. 
                                Let it all hang out!</font></span></span></p>
                            </td>
                          </tr>
                        </table>
                      </td>
              ...
              <tr> 
                ...
                <td width="347" height="2" bgcolor="#009999"><img src="/stccg/global/images/trek/glear.gif" width="1" height="4"></td>
              </tr>
              <tr> 
