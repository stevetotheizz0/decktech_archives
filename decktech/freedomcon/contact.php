      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="5">
        <tr>
          ...
          <td height="268" valign="top"> 
            <p><b>Event Co-Ordinator for FreedomCon II</b><br>
              Mike Carr - <a href="mailto:mikecarr@decktech.net">mikecarr@decktech.net</a><br>
              <br>
			  <b>DPC Manager</b><br>
			  Neal Razi - <a href="mailto:neal@decktech.net">neal@decktech.net</a><br>
			  <BR>
              <b>Event Location</b><br>
              <font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#000000">
			  <a href="http://www.neoquestgames.com">NeoQuest Games</a><br>
              Gary's Plaza<br>
              531 South Broad Street<br>
              Lansdale, PA 19446<br>
              215 855 7035</font> <br>
              <br>
            <p>&nbsp;</p>
          </td>
        </tr>
