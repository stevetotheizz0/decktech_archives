      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td bgcolor="#BF003F" valign="top"><!-- #BeginEditable "Body" --> 
            <p><b>Advanced Search</b><p>Input a phrase (string) to search for that phrase in any of the following fields<form method='post' action='advancedsearch.php'><p>Title:<br><input type='text' size='20' value='' name='title'><p>Short Description:<br><input type='text' size='20' value='' name='description'><p>Card List:<br><input type='text' size='20' value='' name='cards'><p>Strategy Section:<br><input type='text' size='20' value='' name='strategy'><p>Sort by<BR>&nbsp;&nbsp;<input type='radio' name='sortby' value='title' checked>Title&nbsp;&nbsp;<input type='radio' name='sortby' value='date'>Date&nbsp;&nbsp;<input type='radio' name='sortby' value='rating'>Rating<p><input type='hidden' value='1' name='searchstring'><p><input type='submit' value='Search The Deck Database' ></form> <!-- #EndEditable --></td>
