...
Basically, use mob points to get some good activation when you use the DS:Docking Control Room to get the DBs. try and get merrejk and chiraneau out asap. use merrejk to draw the systems, and chiraneau to drain like mad. that is why i have so many SDs, so i can be sure to draw them.
